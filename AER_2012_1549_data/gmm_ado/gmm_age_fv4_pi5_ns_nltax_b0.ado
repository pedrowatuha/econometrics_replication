program gmm_age_fv4_pi5_ns_nltax_b0
	version 11
	...
	quietly {
		...
		local j=`j'+1;
		gen `eps_`j'' 	=	duyw2 - ((`k9')^2*(2*(m_s_u1)-(r_u1)^2*z_eta*inv_mills - (l2_r_u1)^2*l2_z_eta*l2_inv_mills)
						+ (`k10')^2*(2*(m_s_u2)-(r_u2)^2*z_eta*inv_mills - (l2_r_u2)^2*l2_z_eta*l2_inv_mills)
						+ (`k11')^2*(2*(m_s_v1)-(r_v1)^2*z_eta*inv_mills) 
						+ (`k12')^2*(2*(m_s_v2)-(r_v2)^2*z_eta*inv_mills)
						+ 2*(`k9')*(`k10')*(2*m_r_u1u2 - r_u1*r_u2*z_eta*inv_mills - (l2_r_u1)*(l2_r_u2)*l2_z_eta*l2_inv_mills)
		...
		local j=`j'+1;
		gen `eps_`j'' 	=	duyw_lag - (-(`k9')^2*(l2_s_u1 - (l2_r_u1)^2*l2_z_eta*l2_inv_mills)
						-(`k10')^2*(l2_s_u2 -(l2_r_u2)^2*l2_z_eta*l2_inv_mills)
						-2*(`k9')*(`k10')*(l2_r_u1u2-l2_r_u1*l2_r_u2*l2_z_eta*l2_inv_mills)
						- s_me_yw_cons);
		...
		local j=`j'+1;
		gen `eps_`j''	=	duww_duyw - (`k9'*(2*m_r_u1u2 - (r_u1*r_u2)*(z_eta*inv_mills) - (l2_r_u1*l2_r_u2)*l2_z_eta*l2_inv_mills)
						+ `k10'*(2*(m_s_u2) - (r_u2)^2*(z_eta*inv_mills) - (l2_r_u2)^2*l2_z_eta*l2_inv_mills)
						+ `k11'*(2*m_r_v1v2 - (r_v1*r_v2)*z_eta*inv_mills)
						+ `k12'*(2*(m_s_v2) - (r_v2)^2*z_eta*inv_mills) 
		...
		local j=`j'+1;
		gen `eps_`j''	=	duc_duyw - (`k1'*`k9'*(2*(m_s_u1)-(r_u1)^2*z_eta*inv_mills -(l2_r_u1)^2*l2_z_eta*l2_inv_mills)
						+ `k2'*`k10'*(2*(m_s_u2)-(r_u2)^2*(z_eta*inv_mills) - (l2_r_u2)^2*l2_z_eta*l2_inv_mills)
						+ (`k1'*`k10' + `k2'*`k9')*(2*m_r_u1u2 - (r_u1*r_u2)*(z_eta*inv_mills) - (l2_r_u1*l2_r_u2)*l2_z_eta*l2_inv_mills)
						+ `k3'*`k11'*(2*m_s_v1-(r_v1)^2*z_eta*inv_mills)
						+ `k4'*`k12'*(2*m_s_v2-(r_v2)^2*z_eta*inv_mills)
						+ (`k3'*`k12' + `k4'*`k11')*(2*m_r_v1v2 - (r_v1*r_v2)*z_eta*inv_mills));
		
		local j=`j'+1;
		gen `eps_`j''	=	duy_duyw - (`k5'*`k9'*(2*(m_s_u1)-(r_u1)^2*(z_eta*inv_mills) -(l2_r_u1)^2*l2_z_eta*l2_inv_mills)
						+ `k6'*`k10'*(2*(m_s_u2)-(r_u2)^2*z_eta*inv_mills - (l2_r_u2)^2*l2_z_eta*l2_inv_mills)
						+ (`k5'*`k10' + `k6'*`k9')*(2*m_r_u1u2 - (r_u1*r_u2)*(z_eta*inv_mills) - (l2_r_u1*l2_r_u2)*l2_z_eta*l2_inv_mills)
						+ `k7'*`k11'*(2*m_s_v1-(r_v1)^2*z_eta*inv_mills)
						+ `k8'*`k12'*(2*m_s_v2-(r_v2)^2*z_eta*inv_mills)
		...
		local j=`j'+1;
		gen `eps_`j''	=  	duww_duc_lag - (-`k1'*(l2_r_u1u2 - l2_r_u1*l2_r_u2*l2_z_eta*l2_inv_mills)
						-`k2'*(l2_s_u2-(l2_r_u2)^2*l2_z_eta*l2_inv_mills));
		...
		local j=`j'+1;
		gen `eps_`j''	=  	duc_duww_lag - (-`k1'*(l2_r_u1u2 - l2_r_u1*l2_r_u2*l2_z_eta*l2_inv_mills)
						- `k2'*(l2_s_u2 - (l2_r_u2)^2*l2_z_eta*l2_inv_mills));
		...
		local j=`j'+1;
		gen `eps_`j''	=	duyw_duc_lag - (-`k1'*`k9'*(l2_s_u1 - (l2_r_u1)^2*l2_z_eta*l2_inv_mills)
						- (`k1'*`k10'+`k2'*`k9')*(l2_r_u1u2 - l2_r_u1*l2_r_u2*l2_z_eta*l2_inv_mills)
						- `k2'*`k10'*(l2_s_u2 - (l2_r_u2)^2*l2_z_eta*l2_inv_mills));
		...
		local j=`j'+1;
		gen `eps_`j''	=	duc_duyw_lag - (-`k1'*`k9'*(l2_s_u1 - (l2_r_u1)^2*l2_z_eta*l2_inv_mills)
						- (`k1'*`k10'+`k2'*`k9')*(l2_r_u1u2 - l2_r_u1*l2_r_u2*l2_z_eta*l2_inv_mills)
						- `k2'*`k10'*(l2_s_u2-(r_u2)^2*l2_z_eta*l2_inv_mills));
		...
		local j=`j'+1;
		gen `eps_`j''	=  	duww_duyw_lag - (-`k9'*(l2_r_u1u2 - l2_r_u1*l2_r_u2*l2_z_eta*l2_inv_mills)
						- `k10'*(l2_s_u2 -(l2_r_u2)^2*l2_z_eta*l2_inv_mills)
		...
		local j=`j'+1;
		gen `eps_`j''	=  	duyw_duww_lag - (-`k9'*(l2_r_u1u2 - l2_r_u1*l2_r_u2*l2_z_eta*l2_inv_mills)
						-`k10'*(l2_s_u2 -(l2_r_u2)^2*l2_z_eta*l2_inv_mills)
						- (s_me_yw_cons - cov_me_yw_hw_cons));
						
		local j=`j'+1;
		gen `eps_`j''	=  	duw_duyw_lag - (-`k9'*(l2_s_u1 - (l2_r_u1)^2*l2_z_eta*l2_inv_mills)
						-`k10'*(l2_r_u1u2 - l2_r_u1*l2_r_u2*l2_z_eta*l2_inv_mills));

						
		local j=`j'+1;
		gen `eps_`j''	=  	duww_duy_lag - (-`k5'*(l2_r_u1u2 - l2_r_u1*l2_r_u2*l2_z_eta*l2_inv_mills)
						-`k6'*(l2_s_u2 - (l2_r_u2)^2*l2_z_eta*l2_inv_mills));


		local j=`j'+1;
		gen `eps_`j''	=  	duyw_duw_lag - (-`k9'*(l2_s_u1 -(l2_r_u1)^2*l2_z_eta*l2_inv_mills)
						-`k10'*(l2_r_u1u2 - l2_r_u1*l2_r_u2*l2_z_eta*l2_inv_mills));

						
		local j=`j'+1;
		gen `eps_`j''	=  	duy_duww_lag - (-`k5'*(l2_r_u1u2 - l2_r_u1*l2_r_u2*l2_z_eta*l2_inv_mills)
						-`k6'*(l2_s_u2 -(l2_r_u2)^2*l2_z_eta*l2_inv_mills));
