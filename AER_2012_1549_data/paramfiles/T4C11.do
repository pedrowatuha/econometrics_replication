...
global directory "T4C1_gmm"

global bn = 0 	/* number of bootstrap samples. Zero will be no bootstrap */ 
...
global fix_var			= 10			/* 	4- Variances changing by age and participation correction
...
global tax_graph		= 1		/* 1 for tax graph (figure 1 with the accompanied numbers) */
